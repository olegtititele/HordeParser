                ...
                else
                {
                    ...
                    switch (state)
                    {
                        ...
                        case "SellerRating":
                            ...
                            return;
                        case "SellerFeedback":
                            SellerFeedbackState.MessageHandler(botClient, messageText!, chatId, messageId, mainMenuPhoto);
                            return;
                        case "Timeout":
                        ...
                        case "LinksBlacklist":
                            ...
                            return;
                        case "DeleteSellers":
                            DeleteSellersState.MessageHandler(botClient, messageText!, chatId, messageId, mainMenuPhoto);
                            return;
                        default:
                            return;
                    }
